...
| **Multi-Language** | German (default) and English. Language switcher with country flags in settings. |
...
| **Mehrsprachig** | Deutsch (Standard) und Englisch. Sprachumschalter mit Länderflaggen in den Einstellungen. |
